...
function fish_git_prompt --description "Prompt function for Git"
    ...
    set -l space (set_color normal)"$___fish_git_prompt_char_stateseparator"(set_color yellow)
    ...
    if test "$dirtystate$invalidstate$stagedstate$untrackedfiles$stashstate" = 00000
        ...
        for i in $__fish_git_prompt_status_order
            if test $$i != 0
                ...
                set info "$info$color$symbol$color_done"
            end
        end
    end
...
function __fish_git_prompt_validate_chars --description "fish_git_prompt helper, checks char variables"
    ...
    __fish_git_prompt_set_char __fish_git_prompt_char_dirtystate 'd' '✚'
    __fish_git_prompt_set_char __fish_git_prompt_char_invalidstate 'i' '✖'
    __fish_git_prompt_set_char __fish_git_prompt_char_stagedstate 's' '●'
